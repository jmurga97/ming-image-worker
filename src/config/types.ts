...
export interface Bindings {
  ...
  QMENUT_STAGING_BUCKET: R2Bucket;
  QMENUT_MEDIA_BUCKET: R2Bucket;
  ...
  QMENUT_STAGING_BUCKET_NAME: string;
  QMENUT_MEDIA_BUCKET_NAME: string;
  QMENUT_PUBLIC_MEDIA_BASE_URL: string;
